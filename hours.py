...
def convert_ics_to_html(ics_file_path):
    ...
    for component in cal.walk():
        if component.name == "VEVENT":
            ...
            # Calculate duration_hours based on the duration in minutes
            duration_hours = duration_minutes // 45  # Calculate the number of full 45-minute intervals
            remainder_minutes = duration_minutes % 45  # Calculate the remaining minutes after considering full intervals

            # Adjust duration_hours based on the remaining minutes
            if 0 < remainder_minutes <= 15:
                duration_hours += 1
            elif 15 < remainder_minutes <= 30:
                duration_hours += 2
            elif 30 < remainder_minutes <= 45:
                duration_hours += 3
